(() => {
  ...
  const PROJECTS_DATA = {
    "still-moving": {
      ...
      title: "STILL MOVING.",
      titleHtml:
        '<span class="cs-hero__title-line"><span>STILL</span></span><span class="cs-hero__title-line"><span>MOVING.</span></span>',
      category: "BRAND FILM",
      year: "2026",
      runtime: "00:45",
      ...
      summary:
        "A quiet brand film about financial planning and the momentum inside every decision, created by Envizon Films.",
      services:
      ...
      challengeBody:
        "Niyojak needed to talk about financial planning without falling into the usual language of numbers, charts and future promises. The real challenge was simpler: make people feel what those decisions are ultimately for.",
      challengeImage: "assets/images/case-still-moving-challenge.jpg",
      ideaTitle: "One road.<br>A few choices.<br>Everything ahead.",
      ideaBody:
        "Instead of explaining financial planning, the film follows one traveller through a series of quiet decisions. The road becomes the metaphor. Each choice changes what comes next without the film needing to say it directly.",
      ideaFrames: [
        "assets/images/service-case-study-road.jpg",
        "assets/images/case-still-moving-turn.jpg",
        "assets/images/case-still-moving-opening.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-still-moving-hyderabad-sunset.jpg",
          title: "FRAME 01 / THE DEPARTURE",
          time: "00:04",
          loc: "HYDERABAD",
        },
        {
          img: "assets/images/case-still-moving-pause.jpg",
          title: "FRAME 02 / THE PAUSE",
          time: "00:12",
          loc: "",
        },
        {
          img: "assets/images/service-case-study-road.jpg",
          title: "FRAME 03 / THE DECISION",
          time: "00:20",
          loc: "",
        },
        {
          img: "assets/images/case-still-moving-turn.jpg",
          title: "FRAME 04 / THE TURN",
          time: "00:28",
          loc: "",
        },
        {
          img: "assets/images/case-still-moving-opening.jpg",
          title: "FRAME 05 / THE OPENING",
          time: "00:32",
          loc: "",
        },
        {
          img: "assets/images/case-still-moving-hyderabad-day.jpg",
          title: "FRAME 06 / WHAT COMES NEXT",
          time: "00:42",
          loc: "HYDERABAD",
        },
      ],
    ...
    "after-dark": {
      ...
      titleHtml:
        '<span class="cs-hero__title-line"><span>NIGHT</span></span><span class="cs-hero__title-line"><span>BELONGS TO US.</span></span>',
      category: "COMMERCIAL",
      year: "2026",
      runtime: "00:45",
      ...
      summary:
        "A high-contrast nocturnal commercial capturing silent velocity and urban night travel for Voltarc electric scooters.",
      services:
        "CREATIVE DIRECTION · CINEMATOGRAPHY · EDITING · COLOR GRADING · SOUND DESIGN",
      askList: "TV COMMERCIAL · DIGITAL LAUNCH · STILLS LIBRARY",
      roleSummary: "CREATIVE + PRODUCTION + POST",
      challengeTitle: "Reframe urban<br>night travel.",
      challengeBody:
        "Voltarc wanted to position electric mobility not just as an eco-conscious alternative, but as a thrilling, quiet nocturnal experience through Bengaluru's sleeping streets.",
      challengeImage: "assets/images/case-after-dark-apartments.jpg",
      ideaTitle: "Silence<br>in motion.<br>Neon shadows.",
      ideaBody:
        "Filmed in high contrast low-light digital cinematography, capturing neon reflections and quiet velocity across urban arteries as the city sleeps.",
      ideaFrames: [
        "assets/images/case-after-dark-dusk.jpg",
        "assets/images/case-after-dark-towersilhouette.jpg",
        "assets/images/case-after-dark-challenge.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-after-dark-poster.jpg",
          title: "FRAME 01 / THE CITY AT REST",
          time: "00:05",
          loc: "BENGALURU",
        },
        {
          img: "assets/images/case-after-dark-dusk.jpg",
          title: "FRAME 02 / DUSK HANDOVER",
          time: "00:14",
          loc: "",
        },
        {
          img: "assets/images/case-after-dark-towersilhouette.jpg",
          title: "FRAME 03 / THE SIGNAL",
          time: "00:22",
          loc: "",
        },
        {
          img: "assets/images/case-after-dark-raincyclist.jpg",
          title: "FRAME 04 / RAIN & REFLECTION",
          time: "00:30",
          loc: "",
        },
        {
          img: "assets/images/case-after-dark-challenge.jpg",
          title: "FRAME 05 / SILENT VELOCITY",
          time: "00:38",
          loc: "",
        },
        {
          img: "assets/images/case-after-dark-drone.jpg",
          title: "FRAME 06 / BEHIND THE LENS",
          time: "00:44",
          loc: "BENGALURU",
        },
      ],
    ...
    "old-worlds": {
      ...
      titleHtml:
        '<span class="cs-hero__title-line"><span>TIME</span></span><span class="cs-hero__title-line"><span>STANDS STILL.</span></span>',
      ...
      summary:
        "A sensory narrative celebrating heritage craft, architectural grandeur, and quiet luxury at Vilasa Palaces, Udaipur.",
      ...
      challengeBody:
        "Vilasa Palaces required a sensory narrative highlighting heritage craft, architectural grandeur, and hyper-personalised hospitality without relying on conventional voiceovers.",
      challengeImage: "assets/images/case-old-worlds-day.jpg",
      ideaTitle: "Sanctuary<br>of quiet elegance.<br>Palace shadows.",
      ideaBody:
        "Natural light studies focusing on textures, water reflections, and tactile details that evoke calmness and historic splendor across regal archways.",
      ideaFrames: [
        "assets/images/case-old-worlds-hills.jpg",
        "assets/images/case-old-worlds-archway.jpg",
        "assets/images/case-old-worlds-challenge.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-old-worlds-twilight.jpg",
          title: "FRAME 01 / THE ARRIVAL",
          time: "00:08",
          loc: "UDAIPUR",
        },
        {
          img: "assets/images/case-old-worlds-hills.jpg",
          title: "FRAME 02 / THE COURTYARD",
          time: "00:20",
          loc: "",
        },
        {
          img: "assets/images/case-old-worlds-day.jpg",
          title: "FRAME 03 / THE ARCHWAY",
          time: "00:35",
          loc: "",
        },
        {
          img: "assets/images/case-old-worlds-majestic.jpg",
          title: "FRAME 04 / WATER MIRROR",
          time: "00:48",
          loc: "",
        },
        {
          img: "assets/images/case-old-worlds-archway.jpg",
          title: "FRAME 05 / MARBLE RHYTHM",
          time: "01:02",
          loc: "",
        },
        {
          img: "assets/images/case-old-worlds-challenge.jpg",
          title: "FRAME 06 / GOLDEN HOUR",
          time: "01:12",
          loc: "UDAIPUR",
        },
      ],
    ...
    "field-notes": {
      ...
      titleHtml:
        '<span class="cs-hero__title-line"><span>INTO THE</span></span><span class="cs-hero__title-line"><span>BORDERLANDS.</span></span>',
      ...
      summary:
        "An unscripted expedition documentary following trail guides through wet forests and living root bridges in Eastern India, for Trailborn outdoor gear.",
      services:
        "FIELD DIRECTION · DOCUMENTARY CINEMATOGRAPHY · EDITING · SOUND DESIGN",
      ...
      challengeBody:
        "Trailborn needed an unscripted documentary exploring remote trail guides navigating torrential rain and rugged terrain in Eastern India.",
      challengeImage: "assets/images/case-field-notes-challenge.jpg",
      ideaTitle: "Raw elements.<br>Unbroken paths.<br>True wilderness.",
      ideaBody:
        "Handheld 16mm-style digital textures capturing humidity, mist, and authentic human stamina under extreme natural conditions.",
      ideaFrames: [
        "assets/images/case-field-notes-shillong.jpg",
        "assets/images/case-field-notes-waterfall2.jpg",
        "assets/images/case-field-notes-ancient.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-field-notes-poster.jpg",
          title: "FRAME 01 / MIST RIDGE",
          time: "00:15",
          loc: "MEGHALAYA",
        },
        {
          img: "assets/images/case-field-notes-shillong.jpg",
          title: "FRAME 02 / LIVING BRIDGE",
          time: "00:45",
          loc: "",
        },
        {
          img: "assets/images/case-field-notes-riwai.jpg",
          title: "FRAME 03 / RIWAI CROSSING",
          time: "01:10",
          loc: "",
        },
        {
          img: "assets/images/case-field-notes-waterfall1.jpg",
          title: "FRAME 04 / RAIN CANOPY",
          time: "01:40",
          loc: "",
        },
        {
          img: "assets/images/case-field-notes-waterfall2.jpg",
          title: "FRAME 05 / CHERRAPUNJI FALLS",
          time: "02:05",
          loc: "",
        },
        {
          img: "assets/images/case-field-notes-ancient.jpg",
          title: "FRAME 06 / ANCIENT ROOTS",
          time: "02:25",
          loc: "MEGHALAYA",
        },
      ],
    ...
    "new-forms": {
      ...
      titleHtml:
        '<span class="cs-hero__title-line"><span>STUDIO</span></span><span class="cs-hero__title-line"><span>CONVERSATIONS.</span></span>',
      ...
      summary:
        "An intimate studio podcast series exploring deep creative conversations, brand journeys, and visionary insights for Samvaad Studios.",
      services:
        "CREATIVE DIRECTION · MULTI-CAM PRODUCTION · EDIT · AUDIO MASTERING · GRAPHICS",
      askList: "PODCAST SERIES · EPISODIC CUTS · REELS & SHORTS",
      roleSummary: "CREATIVE + PRODUCTION + POST",
      challengeTitle: "Bring authentic conversation<br>to life.",
      challengeBody:
        "Samvaad Studios wanted to move beyond traditional corporate videos and launch a podcast series that captures authentic dialogues, deep human stories, and thought leadership in a visually immersive studio setup.",
      challengeImage: "assets/images/case-new-forms-setup.jpg",
      ideaTitle: "Multi-camera warmth<br>& studio clarity.",
      ideaBody:
        "Combining warm cinematic studio lighting, multi-angle camera coverage, and pristine audio production to create an engaging visual podcast experience.",
      ideaFrames: [
        "assets/images/case-new-forms-mic.jpg",
        "assets/images/case-new-forms-closeup.jpg",
        "assets/images/case-new-forms-hosts.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-new-forms-poster.jpg",
          title: "FRAME 01 / STUDIO SETUP",
          time: "02:15",
          loc: "HYDERABAD",
        },
        {
          img: "assets/images/case-new-forms-mic.jpg",
          title: "FRAME 02 / MIC CHECK",
          time: "14:20",
          loc: "",
        },
        {
          img: "assets/images/case-new-forms-closeup.jpg",
          title: "FRAME 03 / DIALOGUE CUT",
          time: "28:45",
          loc: "",
        },
        {
          img: "assets/images/case-new-forms-hosts.jpg",
          title: "FRAME 04 / GUEST INSIGHT",
          time: "35:10",
          loc: "",
        },
        {
          img: "assets/images/case-new-forms-twowomen.jpg",
          title: "FRAME 05 / KEY TAKEAWAY",
          time: "41:05",
          loc: "",
        },
        {
          img: "assets/images/case-new-forms-challenge.jpg",
          title: "FRAME 06 / CLOSING MOMENT",
          time: "44:30",
          loc: "HYDERABAD",
        },
      ],
    ...
    dhaaga: {
      ...
      titleHtml:
        '<span class="cs-hero__title-line"><span>THREADS</span></span><span class="cs-hero__title-line"><span>OF NOW.</span></span>',
      ...
      summary:
        "A vertical-first content system for Dhaaga, turning Jaipur's block-print heritage into reels-ready fashion stories.",
      services:
        "CONCEPT DEVELOPMENT · SCRIPT · PRODUCTION · EDIT · COLOUR · SOUND",
      ...
      challengeBody:
        "Dhaaga needed its centuries-old block-printing craft to read as contemporary fashion content, built for scroll speed without losing the hand behind every print.",
      challengeImage: "assets/images/case-dhaaga-challenge.jpg",
      ideaTitle: "One print.<br>A hundred retakes.<br>Every thread visible.",
      ideaBody:
        "The film stays close: hands, dye, wood, cloth. Each vertical cut pairs the artisan's process with the finished look, so the product story and the maker's story play as one.",
      ideaFrames: [
        "assets/images/case-dhaaga-model2.jpg",
        "assets/images/case-dhaaga-textiles.jpg",
        "assets/images/case-dhaaga-painting.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-dhaaga-model1.jpg",
          title: "FRAME 01 / THE LOOK",
          time: "00:03",
          loc: "JAIPUR",
        },
        {
          img: "assets/images/case-dhaaga-model2.jpg",
          title: "FRAME 02 / THE DRAPE",
          time: "00:09",
          loc: "",
        },
        {
          img: "assets/images/case-dhaaga-poster.jpg",
          title: "FRAME 03 / THE STAMP",
          time: "00:14",
          loc: "",
        },
        {
          img: "assets/images/case-dhaaga-blocks.jpg",
          title: "FRAME 04 / THE CARVER",
          time: "00:19",
          loc: "",
        },
        {
          img: "assets/images/case-dhaaga-textiles.jpg",
          title: "FRAME 05 / THE PALETTE",
          time: "00:24",
          loc: "",
        },
        {
          img: "assets/images/case-dhaaga-painting.jpg",
          title: "FRAME 06 / THE DETAIL",
          time: "00:29",
          loc: "JAIPUR",
        },
      ],
    ...
    "aroha-wellness": {
      ...
      titleHtml:
        '<span class="cs-hero__title-line"><span>DRINK THE</span></span><span class="cs-hero__title-line"><span>DAY IN.</span></span>',
      category: "COMMERCIAL",
      year: "2026",
      runtime: "00:30",
      ...
      summary:
        "A sun-lit product commercial for Aroha Wellness, turning everyday Indian ingredients into a modern beverage line.",
      services:
        "CREATIVE DIRECTION · FOOD STYLING · CINEMATOGRAPHY · EDIT · COLOUR GRADING",
      askList: "TV COMMERCIAL · DIGITAL CUTDOWNS · STILLS LIBRARY",
      roleSummary: "CREATIVE + PRODUCTION + POST",
      challengeTitle: "Make wellness<br>taste like home.",
      challengeBody:
        "Aroha Wellness didn't want another clean-label ad full of studio gloss. The brief was to shoot ingredients — amla, tulsi, mint — the way a home kitchen actually sees them.",
      challengeImage: "assets/images/case-aroha-lassi.jpg",
      ideaTitle: "Real ingredients.<br>Real light.<br>No filter needed.",
      ideaBody:
        "Shot entirely in natural daylight with unstyled produce, the film treats each recipe like a small ritual, letting texture and steam do what a voiceover usually has to.",
      ideaFrames: [
        "assets/images/case-aroha-tulsi.jpg",
        "assets/images/case-aroha-mango.jpg",
        "assets/images/case-aroha-sparkling.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-aroha-poster.jpg",
          title: "FRAME 01 / THE INGREDIENT",
          time: "00:03",
          loc: "MUMBAI",
        },
        {
          img: "assets/images/case-aroha-tulsi.jpg",
          title: "FRAME 02 / THE INFUSION",
          time: "00:09",
          loc: "",
        },
        {
          img: "assets/images/case-aroha-lassi.jpg",
          title: "FRAME 03 / THE HERITAGE",
          time: "00:14",
          loc: "",
        },
        {
          img: "assets/images/case-aroha-mango.jpg",
          title: "FRAME 04 / THE COOLER",
          time: "00:19",
          loc: "",
        },
        {
          img: "assets/images/case-aroha-sparkling.jpg",
          title: "FRAME 05 / THE FIZZ",
          time: "00:24",
          loc: "",
        },
        {
          img: "assets/images/case-aroha-lemonwater.jpg",
          title: "FRAME 06 / THE POUR",
          time: "00:29",
          loc: "MUMBAI",
        },
      ],
    ...
    "lakshya-learning": {
      ...
      titleHtml:
        '<span class="cs-hero__title-line"><span>EVERY CHILD,</span></span><span class="cs-hero__title-line"><span>A HEADSTART.</span></span>',
      category: "BRAND FILM",
      year: "2026",
      runtime: "00:50",
      ...
      summary:
        "A brand film for Lakshya Learning about what access to a good teacher actually changes in a child's life.",
      services:
        "CONCEPT DEVELOPMENT · SCRIPT · PRODUCTION · EDIT · COLOUR · SOUND",
      askList: "BRAND FILM · CAMPAIGN CUTS · SOCIAL EDITS",
      roleSummary: "CREATIVE + PRODUCTION + POST",
      ...
      challengeBody:
        "Lakshya Learning needed to talk about ed-tech without sounding like a pitch deck. The real story was simpler: what changes when a child gets one more chance to be seen.",
      challengeImage: "assets/images/case-lakshya-challenge.jpg",
      ideaTitle: "One classroom.<br>A hundred versions<br>of the same hope.",
      ideaBody:
        "The film moves between a village school and a city library, following different children through the same quiet moment: someone finally explaining a thing so it makes sense.",
      ideaFrames: [
        "assets/images/case-lakshya-classroom.jpg",
        "assets/images/case-lakshya-homework.jpg",
        "assets/images/case-lakshya-librarystudy.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-lakshya-poster.jpg",
          title: "FRAME 01 / THE FOCUS",
          time: "00:05",
          loc: "NEW DELHI",
        },
        {
          img: "assets/images/case-lakshya-classroom.jpg",
          title: "FRAME 02 / THE CLASSROOM",
          time: "00:14",
          loc: "",
        },
        {
          img: "assets/images/case-lakshya-uniforms.jpg",
          title: "FRAME 03 / THE NOTEBOOK",
          time: "00:22",
          loc: "",
        },
        {
          img: "assets/images/case-lakshya-homework.jpg",
          title: "FRAME 04 / THE PARTNERSHIP",
          time: "00:32",
          loc: "",
        },
        {
          img: "assets/images/case-lakshya-librarystudy.jpg",
          title: "FRAME 05 / THE MENTOR",
          time: "00:41",
          loc: "",
        },
        {
          img: "assets/images/case-lakshya-challenge.jpg",
          title: "FRAME 06 / THE SLATE",
          time: "00:48",
          loc: "NEW DELHI",
        },
      ],
    ...
    suvarna: {
      ...
      titleHtml:
        '<span class="cs-hero__title-line"><span>HEIRLOOMS,</span></span><span class="cs-hero__title-line"><span>MADE TODAY.</span></span>',
      category: "COMMERCIAL",
      year: "2026",
      runtime: "00:35",
      location: "MUMBAI / INDIA",
      ...
      summary:
        "A macro-led jewellery commercial for Suvarna, treating each piece like a small, wearable heirloom.",
      services:
        "CREATIVE DIRECTION · MACRO CINEMATOGRAPHY · EDIT · COLOUR GRADING",
      askList: "TV COMMERCIAL · SOCIAL CUTS · STILLS LIBRARY",
      roleSummary: "CREATIVE + PRODUCTION + POST",
      challengeTitle: "Make gold<br>feel personal.",
      challengeBody:
        "Suvarna's pieces are made to be worn for decades, not just a wedding day. The film needed to sell craftsmanship and permanence, not just carats.",
      challengeImage: "assets/images/case-suvarna-challenge.jpg",
      ideaTitle: "Every piece,<br>a close read.<br>Nothing rushed.",
      ideaBody:
        "Shot entirely in macro, the film lingers on filigree, clasps and stones long enough that the craft becomes the story, not the backdrop to one.",
      ideaFrames: [
        "assets/images/case-suvarna-jhumka.jpg",
        "assets/images/case-suvarna-pendant.jpg",
        "assets/images/case-suvarna-mangalsutra.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-suvarna-poster.jpg",
          title: "FRAME 01 / THE TROUSSEAU",
          time: "00:04",
          loc: "MUMBAI",
        },
        {
          img: "assets/images/case-suvarna-jhumka.jpg",
          title: "FRAME 02 / THE JHUMKA",
          time: "00:10",
          loc: "",
        },
        {
          img: "assets/images/case-suvarna-pendant.jpg",
          title: "FRAME 03 / THE PENDANT",
          time: "00:16",
          loc: "",
        },
        {
          img: "assets/images/case-suvarna-mangalsutra.jpg",
          title: "FRAME 04 / THE MANGALSUTRA",
          time: "00:22",
          loc: "",
        },
        {
          img: "assets/images/case-suvarna-earrings.jpg",
          title: "FRAME 05 / THE PEACOCK",
          time: "00:28",
          loc: "",
        },
        {
          img: "assets/images/case-suvarna-bangles.png",
          title: "FRAME 06 / THE BANGLE",
          time: "00:33",
          loc: "MUMBAI",
        },
      ],
    ...
    nexora: {
      ...
      titleHtml:
        '<span class="cs-hero__title-line"><span>BUILT BY THE</span></span><span class="cs-hero__title-line"><span>PEOPLE IN IT.</span></span>',
      ...
      summary:
        "A corporate film for Nexora Technologies that puts the engineers ahead of the org chart.",
      services:
      ...
      challengeBody:
        "Nexora Technologies wanted a company film that didn't lean on stock footage of server rooms. The ask was to show the actual floor and the actual builders, without it turning into a recruitment brochure.",
      challengeImage: "assets/images/case-nexora-openoffice.jpg",
      ideaTitle: "One floor.<br>Every function.<br>The same energy.",
      ideaBody:
        "The film moves through the Pune campus at a walking pace, letting real workstations, real meetings and real downtime stand in for the mission statement.",
      ideaFrames: [
        "assets/images/case-nexora-ergonomic.jpg",
        "assets/images/case-nexora-desks.jpg",
        "assets/images/case-nexora-laptop.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-nexora-poster.jpg",
          title: "FRAME 01 / THE ATRIUM",
          time: "00:06",
          loc: "PUNE",
        },
        {
          img: "assets/images/case-nexora-openoffice.jpg",
          title: "FRAME 02 / THE FLOOR",
          time: "00:16",
          loc: "",
        },
        {
          img: "assets/images/case-nexora-ergonomic.jpg",
          title: "FRAME 03 / THE LOUNGE",
          time: "00:27",
          loc: "",
        },
        {
          img: "assets/images/case-nexora-desks.jpg",
          title: "FRAME 04 / THE ROW",
          time: "00:37",
          loc: "",
        },
        {
          img: "assets/images/case-nexora-laptop.jpg",
          title: "FRAME 05 / THE ENGINEER",
          time: "00:46",
          loc: "",
        },
        {
          img: "assets/images/service-corporate-films.jpg",
          title: "FRAME 06 / THE MEETING",
          time: "00:53",
          loc: "PUNE",
        },
      ],
    ...
    yawatra: {
      ...
      titleHtml:
        '<span class="cs-hero__title-line"><span>SLOW DOWN</span></span><span class="cs-hero__title-line"><span>TO ARRIVE.</span></span>',
      ...
      summary:
        "A travel film for Yawatra following one houseboat through Kerala's backwaters, built to sell a pace rather than a destination.",
      ...
      challengeBody:
        "Yawatra needed a film that didn't just list backwater destinations. The task was to make stillness itself the selling point, for travellers used to itineraries packed hour to hour.",
      challengeImage: "assets/images/case-yawatra-challenge.jpg",
      ideaTitle: "One houseboat.<br>No itinerary.<br>Everywhere is the view.",
      ideaBody:
        "The film follows a single houseboat from morning departure to evening mooring, with the palms, water lilies and passing boats doing the work a script usually would.",
      ideaFrames: [
        "assets/images/case-yawatra-alappuzha.jpg",
        "assets/images/case-yawatra-vembanad.jpg",
        "assets/images/case-yawatra-palms.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-yawatra-poster.jpg",
          title: "FRAME 01 / THE DEPARTURE",
          time: "00:08",
          loc: "ALLEPPEY",
        },
        {
          img: "assets/images/case-yawatra-alappuzha.jpg",
          title: "FRAME 02 / THE PASSING BOAT",
          time: "00:22",
          loc: "",
        },
        {
          img: "assets/images/case-yawatra-traditional.jpg",
          title: "FRAME 03 / THE MONSOON LIGHT",
          time: "00:38",
          loc: "",
        },
        {
          img: "assets/images/case-yawatra-vembanad.jpg",
          title: "FRAME 04 / THE LILY FIELD",
          time: "00:52",
          loc: "",
        },
        {
          img: "assets/images/case-yawatra-speedboat.jpg",
          title: "FRAME 05 / THE OPEN WATER",
          time: "00:58",
          loc: "",
        },
        {
          img: "assets/images/case-yawatra-palms.jpg",
          title: "FRAME 06 / THE MOORING",
          time: "01:03",
          loc: "ALLEPPEY",
        },
      ],
    ...
    "wedding-story": {
      ...
      titleHtml:
        '<span class="cs-hero__title-line"><span>FOREVER</span></span><span class="cs-hero__title-line"><span>BEGINS TODAY.</span></span>',
      ...
      summary:
        "A breathtaking cinematic wedding story capturing timeless emotions, intimate vows, and grand celebration at a Udaipur palace.",
      services:
        "CREATIVE DIRECTION · CINEMATOGRAPHY · EDIT · COLOUR GRADING · SOUND DESIGN",
      askList: "HERO WEDDING FILM · TEASER CUT · HIGHLIGHTS REEL",
      roleSummary: "CREATIVE + PRODUCTION + POST",
      challengeTitle: "Capture genuine<br>unscripted emotion.",
      challengeBody:
        "Creating a wedding film that balances grand architectural celebration with tender, authentic human moments.",
      challengeImage: "assets/images/case-old-worlds-day.jpg",
      ideaTitle: "Cinematic light<br>& timeless rhythm.",
      ideaBody:
        "Soft natural lighting, fluid movement, and evocative soundscapes to preserve raw emotion.",
      ideaFrames: [
        "assets/images/case-old-worlds-twilight.jpg",
        "assets/images/case-old-worlds-archway.jpg",
        "assets/images/case-old-worlds-majestic.jpg",
      ],
      frames: [
        {
          img: "assets/images/case-old-worlds-challenge.jpg",
        ...
        {
          img: "assets/images/case-old-worlds-archway.jpg",
          title: "FRAME 02 / THE VOWS",
          time: "00:45",
          loc: "",
        },
        {
          img: "assets/images/case-old-worlds-hills.jpg",
          title: "FRAME 03 / THE COURTYARD",
          time: "01:10",
          loc: "",
        },
        {
          img: "assets/images/case-old-worlds-majestic.jpg",
          title: "FRAME 04 / THE RECEPTION",
          time: "01:35",
          loc: "",
        },
        {
          img: "assets/images/case-old-worlds-day.jpg",
          title: "FRAME 05 / THE CELEBRATION",
          time: "01:55",
          loc: "",
        },
        {
          img: "assets/images/case-old-worlds-twilight.jpg",
          title: "FRAME 06 / THE LAST DANCE",
          time: "02:10",
          loc: "UDAIPUR",
        },
      ],
  ...
  const hydrateProjectPage = () => {
    ...
    const filmCaption = document.querySelector(
      ".cs-film-caption-row span:first-child",
    );
    if (playerVideo) {
    ...
    if (ideaFrameImgs.length && project.ideaFrames) {
      ideaFrameImgs.forEach((img, i) => {
        if (project.ideaFrames[i])
          img.setAttribute("src", project.ideaFrames[i]);
      });
    }
    ...
    // 13. Next Project
    const nextProject =
      PROJECTS_DATA[project.nextSlug] || PROJECTS_DATA["after-dark"];
    ...
    const nextIndexStr = document.querySelector(
      ".cs-next-project__top-bar span:last-child",
    );
    ...
    if (prevLink)
      prevLink.setAttribute(
        "href",
        `case-study.html?project=${project.prevSlug}`,
      );
    if (nextCard) {
      nextCard.setAttribute(
        "href",
        `case-study.html?project=${project.nextSlug}`,
      );
      nextCard.setAttribute(
        "aria-label",
        `View next project: ${nextProject.client} — ${nextProject.title}`,
      );
    }
    if (nextIndexStr)
      nextIndexStr.textContent = `CASE STUDY ${project.indexStr}`;
    if (nextBg) nextBg.setAttribute("src", nextProject.poster);
    if (nextSub)
      nextSub.textContent = `NEXT / ${nextProject.indexStr.split("/")[0].trim()} · ${nextProject.client}`;
    ...
    const otherSlugs = Object.keys(PROJECTS_DATA).filter(
      (s) => s !== project.slug,
    );
    relatedCards.forEach((card, i) => {
      if (otherSlugs[i]) {
        ...
        if (p)
          p.textContent = `${relData.client} / ${relData.category} / ${relData.year}`;
      }
    });
  };
  ...
  const initCSAnimations = () => {
    ...
    const heroTitleLines = document.querySelectorAll(
      ...
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          ...
          if (fixedNum) {
            ...
            fixedNum.textContent =
              secIndex < 10 ? `0${secIndex}` : `${secIndex}`;
          }
        },
      });
    }
    ...
    if (ideaFrame && ideaImgs.length > 1 && !prefersReducedMotion) {
      ScrollTrigger.create({
        ...
        onUpdate: (self) => {
          const idx = Math.min(
            ideaImgs.length - 1,
            Math.floor(self.progress * ideaImgs.length),
          );
...
(() => {
  ...
  setText(
    "[data-film-caption]",
    `${project.client} / ${plainTitle} — ${project.category} / ${project.runtime}`,
  );
  ...
  document.querySelectorAll("[data-frame]").forEach((figure) => {
    ...
    if (labels[1])
      labels[1].textContent = [frame.time, frame.loc]
        .filter(Boolean)
        .join(" / ");
  });
  ...
  document.querySelectorAll("[data-related]").forEach((card, index) => {
    ...
    card.setAttribute(
      "aria-label",
      `View ${related.title} for ${related.client}`,
    );
    const image = card.querySelector("img");
    if (image) {
      image.src = related.poster;
      image.alt = `${related.title} project frame`;
    }
    const meta = card.querySelector("p");
    const title = card.querySelector("h3");
    if (meta)
      meta.textContent = `${related.client} / ${related.category} / ${related.year}`;
  ...
  if (previousLink)
    previousLink.href = `case-study.html?project=${project.prevSlug}`;
  const nextImage = document.querySelector("[data-next-image]");
  if (nextImage) {
    nextImage.src = next.poster;
    nextImage.alt = `Next project: ${next.title}`;
  }
  ...
  if (schema)
    schema.textContent = JSON.stringify({
      ...
      productionCompany: { "@type": "Organization", name: "Envizon Films" },
    });
  ...
  const updatePlayer = () => {
    ...
    if (toggle) {
      ...
      if (icon)
        icon.className = playing ? "ph-light ph-pause" : "ph-light ph-play";
    }
    if (time)
      time.textContent = `${formatTime(playerVideo.currentTime)} / ${formatTime(playerVideo.duration)}`;
    if (seek && playerVideo.duration)
      seek.value = String(
        (playerVideo.currentTime / playerVideo.duration) * 1000,
      );
  ...
  [bigPlay, toggle].forEach((button) =>
    button?.addEventListener("click", togglePlayback),
  );
  seek?.addEventListener("input", () => {
    if (playerVideo?.duration)
      playerVideo.currentTime =
        (Number(seek.value) / 1000) * playerVideo.duration;
  });
  mute?.addEventListener("click", () => {
    ...
    mute.setAttribute(
      "aria-label",
      playerVideo.muted ? "Unmute film" : "Mute film",
    );
    const icon = mute.querySelector("i");
    if (icon)
      icon.className = playerVideo.muted
        ? "ph-light ph-speaker-slash"
        : "ph-light ph-speaker-high";
  });
  ...
  if (heroVideo && "IntersectionObserver" in window) {
    new IntersectionObserver(
      ([entry]) => {
        if (entry.isIntersecting && playerVideo?.paused)
